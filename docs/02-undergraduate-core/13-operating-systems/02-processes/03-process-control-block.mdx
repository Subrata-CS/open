...
sidebar_label: "Process control block"
sidebar_position: 3
description: "Process control block — Undergraduate Core › Operating Systems › Processes"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Operating Systems › Processes
  ---------------------------------------------------------------------------
*/}
