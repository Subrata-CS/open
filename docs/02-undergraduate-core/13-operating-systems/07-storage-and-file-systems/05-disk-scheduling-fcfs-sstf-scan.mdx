...
sidebar_label: "Disk scheduling — FCFS, SSTF, SCAN"
sidebar_position: 5
description: "Disk scheduling — FCFS, SSTF, SCAN — Undergraduate Core › Operating Systems › Storage and file systems"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Operating Systems › Storage and file systems
  ---------------------------------------------------------------------------
*/}
