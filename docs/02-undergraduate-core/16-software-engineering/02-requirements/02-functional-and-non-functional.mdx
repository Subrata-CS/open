...
sidebar_label: "Functional and non-functional"
sidebar_position: 2
description: "Functional and non-functional — Undergraduate Core › Software Engineering › Requirements"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Software Engineering › Requirements
  ---------------------------------------------------------------------------
*/}
