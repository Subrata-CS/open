---
title: "Deferred and immediate update"
sidebar_label: "Deferred and immediate update"
sidebar_position: 3
description: "Deferred and immediate update — Undergraduate Core › Database Systems › Recovery"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Database Systems › Recovery
  ---------------------------------------------------------------------------
*/}
