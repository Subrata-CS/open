...
sidebar_label: "Dense and sparse indexes"
sidebar_position: 4
description: "Dense and sparse indexes — Undergraduate Core › Database Systems › Storage and indexing"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Database Systems › Storage and indexing
  ---------------------------------------------------------------------------
*/}
