...
sidebar_label: "Generalisation and specialisation"
sidebar_position: 6
description: "Generalisation and specialisation — Undergraduate Core › Database Systems › ER modelling"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Database Systems › ER modelling
  ---------------------------------------------------------------------------
*/}
