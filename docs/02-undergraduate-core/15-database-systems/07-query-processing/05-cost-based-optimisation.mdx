---
title: "Cost-based optimisation"
sidebar_label: "Cost-based optimisation"
sidebar_position: 5
description: "Cost-based optimisation — Undergraduate Core › Database Systems › Query processing"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Database Systems › Query processing
  ---------------------------------------------------------------------------
*/}
