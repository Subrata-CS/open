...
sidebar_label: "Derivations and parse trees"
sidebar_position: 2
description: "Derivations and parse trees — Undergraduate Core › Theory of Computation › Context-free languages"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Theory of Computation › Context-free languages
  ---------------------------------------------------------------------------
*/}
