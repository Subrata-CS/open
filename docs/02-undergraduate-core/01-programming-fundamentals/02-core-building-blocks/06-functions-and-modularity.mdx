...
sidebar_label: "Functions and modularity"
sidebar_position: 6
description: "Functions and modularity — Undergraduate Core › Programming Fundamentals › Core building blocks"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Fundamentals › Core building blocks
  ---------------------------------------------------------------------------
*/}
