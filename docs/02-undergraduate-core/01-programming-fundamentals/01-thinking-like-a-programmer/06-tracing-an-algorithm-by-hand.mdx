---
title: "Tracing an algorithm by hand"
sidebar_label: "Tracing an algorithm by hand"
sidebar_position: 6
description: "Tracing an algorithm by hand — Undergraduate Core › Programming Fundamentals › Thinking like a programmer"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Fundamentals › Thinking like a programmer
  ---------------------------------------------------------------------------
*/}
