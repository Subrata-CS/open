---
title: "Comments that help"
sidebar_label: "Comments that help"
sidebar_position: 2
description: "Comments that help — Undergraduate Core › Programming Fundamentals › Good habits"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Fundamentals › Good habits
  ---------------------------------------------------------------------------
*/}
