...
sidebar_label: "Simple searching"
sidebar_position: 5
description: "Simple searching — Undergraduate Core › Programming Fundamentals › Working with data"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Fundamentals › Working with data
  ---------------------------------------------------------------------------
*/}
