...
sidebar_label: "Use case diagrams"
sidebar_position: 3
description: "Use case diagrams — Undergraduate Core › Object-Oriented Programming › UML"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Object-Oriented Programming › UML
  ---------------------------------------------------------------------------
*/}
