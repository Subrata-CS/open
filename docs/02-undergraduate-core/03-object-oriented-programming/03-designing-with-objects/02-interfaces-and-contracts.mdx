...
sidebar_label: "Interfaces and contracts"
sidebar_position: 2
description: "Interfaces and contracts — Undergraduate Core › Object-Oriented Programming › Designing with objects"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Object-Oriented Programming › Designing with objects
  ---------------------------------------------------------------------------
*/}
