---
title: "State minimisation"
sidebar_label: "State minimisation"
sidebar_position: 7
description: "State minimisation — Undergraduate Core › Digital Logic Design › Sequential circuits"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Digital Logic Design › Sequential circuits
  ---------------------------------------------------------------------------
*/}
