...
sidebar_label: "Creating and switching"
sidebar_position: 2
description: "Creating and switching — Undergraduate Core › Git and Version Control › Branching"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Git and Version Control › Branching
  ---------------------------------------------------------------------------
*/}
