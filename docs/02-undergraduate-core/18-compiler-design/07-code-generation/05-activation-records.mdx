...
sidebar_label: "Activation records"
sidebar_position: 5
description: "Activation records — Undergraduate Core › Compiler Design › Code generation"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Compiler Design › Code generation
  ---------------------------------------------------------------------------
*/}
