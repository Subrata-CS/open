---
title: "Quadruples and triples"
sidebar_label: "Quadruples and triples"
sidebar_position: 2
description: "Quadruples and triples — Undergraduate Core › Compiler Design › Intermediate code"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Compiler Design › Intermediate code
  ---------------------------------------------------------------------------
*/}
