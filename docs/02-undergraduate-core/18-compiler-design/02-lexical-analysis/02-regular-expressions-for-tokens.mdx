---
title: "Regular expressions for tokens"
sidebar_label: "Regular expressions for tokens"
sidebar_position: 2
description: "Regular expressions for tokens — Undergraduate Core › Compiler Design › Lexical analysis"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Compiler Design › Lexical analysis
  ---------------------------------------------------------------------------
*/}
