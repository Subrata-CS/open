...
sidebar_label: "Peephole optimisation"
sidebar_position: 5
description: "Peephole optimisation — Undergraduate Core › Compiler Design › Optimisation"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Compiler Design › Optimisation
  ---------------------------------------------------------------------------
*/}
