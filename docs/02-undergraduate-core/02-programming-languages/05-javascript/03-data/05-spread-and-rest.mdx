...
sidebar_label: "Spread and rest"
sidebar_position: 5
description: "Spread and rest — Undergraduate Core › Programming Languages › JavaScript › Data"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › JavaScript › Data
  ---------------------------------------------------------------------------
*/}
