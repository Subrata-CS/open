...
sidebar_label: "Selecting and changing elements"
sidebar_position: 2
description: "Selecting and changing elements — Undergraduate Core › Programming Languages › JavaScript › The browser"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › JavaScript › The browser
  ---------------------------------------------------------------------------
*/}
