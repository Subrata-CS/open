...
sidebar_label: "Scope, hoisting and closures"
sidebar_position: 7
description: "Scope, hoisting and closures — Undergraduate Core › Programming Languages › JavaScript › Core language"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › JavaScript › Core language
  ---------------------------------------------------------------------------
*/}
