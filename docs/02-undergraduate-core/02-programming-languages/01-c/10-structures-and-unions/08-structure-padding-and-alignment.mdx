...
sidebar_label: "Structure padding and alignment"
sidebar_position: 8
description: "Structure padding and alignment — Undergraduate Core › Programming Languages › C › Structures and unions"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › C › Structures and unions
  ---------------------------------------------------------------------------
*/}
