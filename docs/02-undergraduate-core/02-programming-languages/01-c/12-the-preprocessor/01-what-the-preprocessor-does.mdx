...
sidebar_label: "What the preprocessor does"
sidebar_position: 1
description: "What the preprocessor does — Undergraduate Core › Programming Languages › C › The preprocessor"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › C › The preprocessor
  ---------------------------------------------------------------------------
*/}
