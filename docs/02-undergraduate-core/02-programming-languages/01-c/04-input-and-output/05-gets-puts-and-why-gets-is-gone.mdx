---
title: "gets, puts and why gets is gone"
sidebar_label: "gets, puts and why gets is gone"
sidebar_position: 5
description: "gets, puts and why gets is gone — Undergraduate Core › Programming Languages › C › Input and output"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › C › Input and output
  ---------------------------------------------------------------------------
*/}
