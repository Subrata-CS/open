---
title: "How compilation works — source to executable"
sidebar_label: "How compilation works — source to executable"
sidebar_position: 4
description: "How compilation works — source to executable — Undergraduate Core › Programming Languages › C › Getting started"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › C › Getting started
  ---------------------------------------------------------------------------
*/}
