---
title: "Why C has no call by reference"
sidebar_label: "Why C has no call by reference"
sidebar_position: 6
description: "Why C has no call by reference — Undergraduate Core › Programming Languages › C › Functions"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › C › Functions
  ---------------------------------------------------------------------------
*/}
