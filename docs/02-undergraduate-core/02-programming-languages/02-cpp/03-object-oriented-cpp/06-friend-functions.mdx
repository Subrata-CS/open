...
sidebar_label: "Friend functions"
sidebar_position: 6
description: "Friend functions — Undergraduate Core › Programming Languages › C++ › Object-oriented C++"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › C++ › Object-oriented C++
  ---------------------------------------------------------------------------
*/}
