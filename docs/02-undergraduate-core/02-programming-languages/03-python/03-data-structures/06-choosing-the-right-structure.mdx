...
sidebar_label: "Choosing the right structure"
sidebar_position: 6
description: "Choosing the right structure — Undergraduate Core › Programming Languages › Python › Data structures"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › Python › Data structures
  ---------------------------------------------------------------------------
*/}
