...
sidebar_label: "Default and keyword arguments"
sidebar_position: 11
description: "Default and keyword arguments — Undergraduate Core › Programming Languages › Python › Core language"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › Python › Core language
  ---------------------------------------------------------------------------
*/}
