...
sidebar_label: "Attributes and methods"
sidebar_position: 2
description: "Attributes and methods — Undergraduate Core › Programming Languages › Python › Object-oriented Python"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › Python › Object-oriented Python
  ---------------------------------------------------------------------------
*/}
