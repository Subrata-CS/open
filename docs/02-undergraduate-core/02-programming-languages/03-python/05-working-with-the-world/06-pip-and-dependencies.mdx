---
title: "pip and dependencies"
sidebar_label: "pip and dependencies"
sidebar_position: 6
description: "pip and dependencies — Undergraduate Core › Programming Languages › Python › Working with the world"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › Python › Working with the world
  ---------------------------------------------------------------------------
*/}
