...
sidebar_label: "Lambdas and functional interfaces"
sidebar_position: 3
description: "Lambdas and functional interfaces — Undergraduate Core › Programming Languages › Java › Going further"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › Java › Going further
  ---------------------------------------------------------------------------
*/}
