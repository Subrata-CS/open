...
sidebar_label: "Records and sealed types"
sidebar_position: 9
description: "Records and sealed types — Undergraduate Core › Programming Languages › Java › Object-oriented Java"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › Java › Object-oriented Java
  ---------------------------------------------------------------------------
*/}
