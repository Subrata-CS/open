...
sidebar_label: "Types and variables"
sidebar_position: 1
description: "Types and variables — Undergraduate Core › Programming Languages › Java › Core language"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › Java › Core language
  ---------------------------------------------------------------------------
*/}
