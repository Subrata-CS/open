---
title: "Project — design and query a real schema"
sidebar_label: "Project — design and query a real schema"
sidebar_position: 2
description: "Project — design and query a real schema — Undergraduate Core › Programming Languages › SQL › Practice"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › SQL › Practice
  ---------------------------------------------------------------------------
*/}

# Project — design and query a real schema
