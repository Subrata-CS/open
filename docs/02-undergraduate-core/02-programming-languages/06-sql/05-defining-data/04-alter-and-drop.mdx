---
title: "ALTER and DROP"
sidebar_label: "ALTER and DROP"
sidebar_position: 4
description: "ALTER and DROP — Undergraduate Core › Programming Languages › SQL › Defining data"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › SQL › Defining data
  ---------------------------------------------------------------------------
*/}
