...
sidebar_position: 4
description: "Transactions — Undergraduate Core › Programming Languages › SQL › Changing data"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Programming Languages › SQL › Changing data
  ---------------------------------------------------------------------------
*/}
