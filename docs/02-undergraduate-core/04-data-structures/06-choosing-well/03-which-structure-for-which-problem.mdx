---
title: "Which structure for which problem"
sidebar_label: "Which structure for which problem"
sidebar_position: 3
description: "Which structure for which problem — Undergraduate Core › Data Structures › Choosing well"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Data Structures › Choosing well
  ---------------------------------------------------------------------------
*/}
