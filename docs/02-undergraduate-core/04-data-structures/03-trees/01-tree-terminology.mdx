...
sidebar_label: "Tree terminology"
sidebar_position: 1
description: "Tree terminology — Undergraduate Core › Data Structures › Trees"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Data Structures › Trees
  ---------------------------------------------------------------------------
*/}
