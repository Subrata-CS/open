---
title: "The greedy idea"
sidebar_label: "The greedy idea"
sidebar_position: 1
description: "The greedy idea — Undergraduate Core › Algorithms › Greedy algorithms"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Algorithms › Greedy algorithms
  ---------------------------------------------------------------------------
*/}
