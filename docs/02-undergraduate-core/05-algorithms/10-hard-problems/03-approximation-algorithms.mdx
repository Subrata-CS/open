...
sidebar_label: "Approximation algorithms"
sidebar_position: 3
description: "Approximation algorithms — Undergraduate Core › Algorithms › Hard problems"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Algorithms › Hard problems
  ---------------------------------------------------------------------------
*/}
