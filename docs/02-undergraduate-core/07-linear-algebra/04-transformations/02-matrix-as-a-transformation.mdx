...
sidebar_label: "Matrix as a transformation"
sidebar_position: 2
description: "Matrix as a transformation — Undergraduate Core › Linear Algebra › Transformations"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Linear Algebra › Transformations
  ---------------------------------------------------------------------------
*/}
