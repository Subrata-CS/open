...
sidebar_label: "Basis and dimension"
sidebar_position: 9
description: "Basis and dimension — Undergraduate Core › Linear Algebra › Vectors"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Linear Algebra › Vectors
  ---------------------------------------------------------------------------
*/}
