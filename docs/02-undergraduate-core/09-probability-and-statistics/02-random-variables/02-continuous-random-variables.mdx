...
sidebar_label: "Continuous random variables"
sidebar_position: 2
description: "Continuous random variables — Undergraduate Core › Probability and Statistics › Random variables"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Probability and Statistics › Random variables
  ---------------------------------------------------------------------------
*/}
