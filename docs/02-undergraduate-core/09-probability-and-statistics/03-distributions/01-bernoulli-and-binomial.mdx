...
sidebar_label: "Bernoulli and binomial"
sidebar_position: 1
description: "Bernoulli and binomial — Undergraduate Core › Probability and Statistics › Distributions"
draft: true
---
...
{/*
  ...
  Breadcrumb: Undergraduate Core › Probability and Statistics › Distributions
  ---------------------------------------------------------------------------
*/}
