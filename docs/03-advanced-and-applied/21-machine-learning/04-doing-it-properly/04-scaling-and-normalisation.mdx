...
sidebar_label: "Scaling and normalisation"
sidebar_position: 4
description: "Scaling and normalisation — Advanced and Applied › Machine Learning › Doing it properly"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Machine Learning › Doing it properly
  ---------------------------------------------------------------------------
*/}
