...
sidebar_label: "Activities and fragments"
sidebar_position: 2
description: "Activities and fragments — Advanced and Applied › Mobile Development › Android"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Mobile Development › Android
  ---------------------------------------------------------------------------
*/}
