...
sidebar_label: "Accessibility and inclusive design"
sidebar_position: 6
description: "Accessibility and inclusive design — Advanced and Applied › Human–Computer Interaction › Design"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Human–Computer Interaction › Design
  ---------------------------------------------------------------------------
*/}
