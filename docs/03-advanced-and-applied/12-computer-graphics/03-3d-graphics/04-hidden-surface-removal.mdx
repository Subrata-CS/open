...
sidebar_label: "Hidden surface removal"
sidebar_position: 4
description: "Hidden surface removal — Advanced and Applied › Computer Graphics › 3D graphics"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Computer Graphics › 3D graphics
  ---------------------------------------------------------------------------
*/}
