---
title: "A first 3D scene"
sidebar_label: "A first 3D scene"
sidebar_position: 3
description: "A first 3D scene — Advanced and Applied › Computer Graphics › Practice"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Computer Graphics › Practice
  ---------------------------------------------------------------------------
*/}
