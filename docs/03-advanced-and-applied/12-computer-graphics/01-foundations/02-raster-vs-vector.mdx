...
sidebar_label: "Raster vs vector"
sidebar_position: 2
description: "Raster vs vector — Advanced and Applied › Computer Graphics › Foundations"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Computer Graphics › Foundations
  ---------------------------------------------------------------------------
*/}
