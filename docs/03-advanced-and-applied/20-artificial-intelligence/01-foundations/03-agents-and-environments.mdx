...
sidebar_label: "Agents and environments"
sidebar_position: 3
description: "Agents and environments — Advanced and Applied › Artificial Intelligence › Foundations"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Artificial Intelligence › Foundations
  ---------------------------------------------------------------------------
*/}
