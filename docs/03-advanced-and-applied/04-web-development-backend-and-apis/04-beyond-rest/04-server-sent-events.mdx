...
sidebar_position: 4
description: "Server-sent events — Advanced and Applied › Web Development — Backend and APIs › Beyond REST"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Web Development — Backend and APIs › Beyond REST
  ---------------------------------------------------------------------------
*/}
