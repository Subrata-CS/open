---
title: "Hard and soft real-time"
sidebar_label: "Hard and soft real-time"
sidebar_position: 1
description: "Hard and soft real-time — Advanced and Applied › Real-Time Systems › Foundations"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Real-Time Systems › Foundations
  ---------------------------------------------------------------------------
*/}
