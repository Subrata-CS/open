...
sidebar_label: "When not to use a pattern"
sidebar_position: 2
description: "When not to use a pattern — Advanced and Applied › Design Patterns › Foundations"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Design Patterns › Foundations
  ---------------------------------------------------------------------------
*/}
