...
sidebar_label: "The shared responsibility model"
sidebar_position: 5
description: "The shared responsibility model — Advanced and Applied › Cloud Computing › Foundations"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Cloud Computing › Foundations
  ---------------------------------------------------------------------------
*/}
