...
sidebar_label: "The vector space model"
sidebar_position: 3
description: "The vector space model — Advanced and Applied › Information Retrieval › Ranking"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Information Retrieval › Ranking
  ---------------------------------------------------------------------------
*/}
