...
sidebar_label: "Precision and recall in IR"
sidebar_position: 1
description: "Precision and recall in IR — Advanced and Applied › Information Retrieval › Evaluation"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Information Retrieval › Evaluation
  ---------------------------------------------------------------------------
*/}
