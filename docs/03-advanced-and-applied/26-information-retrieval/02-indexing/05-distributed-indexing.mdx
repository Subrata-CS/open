...
sidebar_label: "Distributed indexing"
sidebar_position: 5
description: "Distributed indexing — Advanced and Applied › Information Retrieval › Indexing"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Information Retrieval › Indexing
  ---------------------------------------------------------------------------
*/}
