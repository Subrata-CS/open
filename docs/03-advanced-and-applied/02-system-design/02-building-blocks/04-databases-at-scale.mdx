...
sidebar_label: "Databases at scale"
sidebar_position: 4
description: "Databases at scale — Advanced and Applied › System Design › Building blocks"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › System Design › Building blocks
  ---------------------------------------------------------------------------
*/}
