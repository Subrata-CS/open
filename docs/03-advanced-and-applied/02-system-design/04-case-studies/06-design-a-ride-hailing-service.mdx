...
sidebar_label: "Design a ride hailing service"
sidebar_position: 6
description: "Design a ride hailing service — Advanced and Applied › System Design › Case studies"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › System Design › Case studies
  ---------------------------------------------------------------------------
*/}
