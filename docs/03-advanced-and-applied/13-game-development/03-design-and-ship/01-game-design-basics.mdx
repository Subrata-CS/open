...
sidebar_label: "Game design basics"
sidebar_position: 1
description: "Game design basics — Advanced and Applied › Game Development › Design and ship"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Game Development › Design and ship
  ---------------------------------------------------------------------------
*/}
