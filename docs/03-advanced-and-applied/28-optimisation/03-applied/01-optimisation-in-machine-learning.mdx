...
sidebar_label: "Optimisation in machine learning"
sidebar_position: 1
description: "Optimisation in machine learning — Advanced and Applied › Optimisation › Applied"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Optimisation › Applied
  ---------------------------------------------------------------------------
*/}
