---
title: "A first Raspberry Pi project"
sidebar_label: "A first Raspberry Pi project"
sidebar_position: 6
description: "A first Raspberry Pi project — Advanced and Applied › Embedded Systems › Building systems"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Embedded Systems › Building systems
  ---------------------------------------------------------------------------
*/}
