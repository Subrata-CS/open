...
sidebar_label: "Sensors and actuators"
sidebar_position: 6
description: "Sensors and actuators — Advanced and Applied › Embedded Systems › Hardware interface"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Embedded Systems › Hardware interface
  ---------------------------------------------------------------------------
*/}
