...
sidebar_label: "Components and props"
sidebar_position: 3
description: "Components and props — Advanced and Applied › Web Development — Frontend › Frameworks"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Web Development — Frontend › Frameworks
  ---------------------------------------------------------------------------
*/}
