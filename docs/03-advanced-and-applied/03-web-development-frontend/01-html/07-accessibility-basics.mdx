...
sidebar_label: "Accessibility basics"
sidebar_position: 7
description: "Accessibility basics — Advanced and Applied › Web Development — Frontend › HTML"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Web Development — Frontend › HTML
  ---------------------------------------------------------------------------
*/}
