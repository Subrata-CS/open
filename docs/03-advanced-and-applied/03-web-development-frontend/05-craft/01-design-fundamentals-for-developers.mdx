...
sidebar_label: "Design fundamentals for developers"
sidebar_position: 1
description: "Design fundamentals for developers — Advanced and Applied › Web Development — Frontend › Craft"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Web Development — Frontend › Craft
  ---------------------------------------------------------------------------
*/}
