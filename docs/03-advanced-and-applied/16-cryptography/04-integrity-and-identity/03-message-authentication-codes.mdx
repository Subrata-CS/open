...
sidebar_label: "Message authentication codes"
sidebar_position: 3
description: "Message authentication codes — Advanced and Applied › Cryptography › Integrity and identity"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Cryptography › Integrity and identity
  ---------------------------------------------------------------------------
*/}
