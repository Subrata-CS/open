...
sidebar_label: "Currying and partial application"
sidebar_position: 3
description: "Currying and partial application — Advanced and Applied › Functional Programming › Core ideas"
draft: true
---
...
{/*
  ...
  Breadcrumb: Advanced and Applied › Functional Programming › Core ideas
  ---------------------------------------------------------------------------
*/}
