---
title: "Taking notes that are worth re-reading"
sidebar_label: "Taking notes that are worth re-reading"
sidebar_position: 3
description: "Taking notes that are worth re-reading — Foundation › How to Learn Computer Science › Learning well"
draft: true
---
...
{/*
  ...
  Breadcrumb: Foundation › How to Learn Computer Science › Learning well
  ---------------------------------------------------------------------------
*/}
