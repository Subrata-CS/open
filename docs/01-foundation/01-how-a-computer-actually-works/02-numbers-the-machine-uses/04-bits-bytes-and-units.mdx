---
title: "Bits, bytes and units"
sidebar_label: "Bits, bytes and units"
sidebar_position: 4
description: "Bits, bytes and units — Foundation › How a Computer Actually Works › Numbers the machine uses"
draft: true
---
