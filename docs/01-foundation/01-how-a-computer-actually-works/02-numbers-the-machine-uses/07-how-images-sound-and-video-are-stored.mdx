---
title: "How images, sound and video are stored"
sidebar_label: "How images, sound and video are stored"
sidebar_position: 7
description: "How images, sound and video are stored — Foundation › How a Computer Actually Works › Numbers the machine uses"
draft: true
---
...
{/*
  ...
  Breadcrumb: Foundation › How a Computer Actually Works › Numbers the machine uses
  ---------------------------------------------------------------------------
*/}
