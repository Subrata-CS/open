...
sidebar_label: "Fundamental counting principle"
sidebar_position: 1
description: "Fundamental counting principle — Foundation › School Mathematics Refresher › Counting"
draft: true
---
...
{/*
  ...
  Breadcrumb: Foundation › School Mathematics Refresher › Counting
  ---------------------------------------------------------------------------
*/}
