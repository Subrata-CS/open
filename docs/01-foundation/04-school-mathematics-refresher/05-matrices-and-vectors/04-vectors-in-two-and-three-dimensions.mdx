...
sidebar_label: "Vectors in two and three dimensions"
sidebar_position: 4
description: "Vectors in two and three dimensions — Foundation › School Mathematics Refresher › Matrices and vectors"
draft: true
---
...
{/*
  ...
  Breadcrumb: Foundation › School Mathematics Refresher › Matrices and vectors
  ---------------------------------------------------------------------------
*/}
