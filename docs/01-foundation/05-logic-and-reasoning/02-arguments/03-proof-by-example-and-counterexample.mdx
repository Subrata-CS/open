---
title: "Proof by example and counterexample"
sidebar_label: "Proof by example and counterexample"
sidebar_position: 3
description: "Proof by example and counterexample — Foundation › Logic and Reasoning › Arguments"
draft: true
---
...
{/*
  ...
  Breadcrumb: Foundation › Logic and Reasoning › Arguments
  ---------------------------------------------------------------------------
*/}
