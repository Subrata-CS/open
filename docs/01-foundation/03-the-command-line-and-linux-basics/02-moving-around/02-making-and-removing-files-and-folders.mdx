---
title: "Making and removing files and folders"
sidebar_label: "Making and removing files and folders"
sidebar_position: 2
description: "Making and removing files and folders — Foundation › The Command Line and Linux Basics › Moving around"
draft: true
---
...
{/*
  ...
  Breadcrumb: Foundation › The Command Line and Linux Basics › Moving around
  ---------------------------------------------------------------------------
*/}
