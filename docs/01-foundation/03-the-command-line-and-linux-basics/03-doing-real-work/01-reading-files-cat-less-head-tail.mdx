...
sidebar_label: "Reading files — cat, less, head, tail"
sidebar_position: 1
description: "Reading files — cat, less, head, tail — Foundation › The Command Line and Linux Basics › Doing real work"
draft: true
---
