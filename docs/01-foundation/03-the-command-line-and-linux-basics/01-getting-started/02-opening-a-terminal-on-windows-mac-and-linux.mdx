---
title: "Opening a terminal on Windows, Mac and Linux"
sidebar_label: "Opening a terminal on Windows, Mac and Linux"
sidebar_position: 2
description: "Opening a terminal on Windows, Mac and Linux — Foundation › The Command Line and Linux Basics › Getting started"
draft: true
---
...
{/*
  ...
  Breadcrumb: Foundation › The Command Line and Linux Basics › Getting started
  ---------------------------------------------------------------------------
*/}
