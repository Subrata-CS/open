...
sidebar_label: "Language design trade-offs"
sidebar_position: 11
description: "Language design trade-offs — Specialisation › Programming Language Theory › Topics"
draft: true
---
...
{/*
  ...
  Breadcrumb: Specialisation › Programming Language Theory › Topics
  ---------------------------------------------------------------------------
*/}
