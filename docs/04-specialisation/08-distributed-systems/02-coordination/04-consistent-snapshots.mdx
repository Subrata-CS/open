---
title: "Consistent snapshots"
sidebar_label: "Consistent snapshots"
sidebar_position: 4
description: "Consistent snapshots — Specialisation › Distributed Systems › Coordination"
draft: true
---
...
{/*
  ...
  Breadcrumb: Specialisation › Distributed Systems › Coordination
  ---------------------------------------------------------------------------
*/}
