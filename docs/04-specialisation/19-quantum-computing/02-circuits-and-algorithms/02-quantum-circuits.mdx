...
sidebar_label: "Quantum circuits"
sidebar_position: 2
description: "Quantum circuits — Specialisation › Quantum Computing › Circuits and algorithms"
draft: true
---
...
{/*
  ...
  Breadcrumb: Specialisation › Quantum Computing › Circuits and algorithms
  ---------------------------------------------------------------------------
*/}
