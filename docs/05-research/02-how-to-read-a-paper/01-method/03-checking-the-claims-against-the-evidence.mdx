---
title: "Checking the claims against the evidence"
sidebar_label: "Checking the claims against the evidence"
sidebar_position: 3
description: "Checking the claims against the evidence — Research › How to Read a Paper › Method"
draft: true
---
...
{/*
  ...
  Breadcrumb: Research › How to Read a Paper › Method
  ---------------------------------------------------------------------------
*/}
