---
title: "Figures and tables that earn space"
sidebar_label: "Figures and tables that earn space"
sidebar_position: 2
description: "Figures and tables that earn space — Research › How to Write a Paper › Craft"
draft: true
---
...
{/*
  ...
  Breadcrumb: Research › How to Write a Paper › Craft
  ---------------------------------------------------------------------------
*/}
