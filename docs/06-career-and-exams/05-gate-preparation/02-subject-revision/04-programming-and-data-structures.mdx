...
sidebar_label: "Programming and data structures"
sidebar_position: 4
description: "Programming and data structures — Career and Exams › GATE Preparation › Subject revision"
draft: true
---
...
{/*
  ...
  Breadcrumb: Career and Exams › GATE Preparation › Subject revision
  ---------------------------------------------------------------------------
*/}
